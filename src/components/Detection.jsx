...
export default function Detection({ lang = "en" }) {
  ...
  const t = {
    ...
    bn: {
      title: "একটি গাছের ছবি আপলোড করুন",
      subtitle: "গাছের প্রজাতি সনাক্ত করতে একটি ছবি আপলোড করুন।",
      uploadPlaceholder: "🌿 ছবি ড্র্যাগ করুন বা ক্লিক করে আপলোড করুন",
      analyze: "উদ্ভিদের বিশ্লেষণ করুন",
      reset: "রিসেট করুন",
      error: "অনুগ্রহ করে একটি বৈধ ছবি ফাইল আপলোড করুন।",
      search: "উদ্ভিদের নাম বা গণ অনুসন্ধান করুন...",
      common: "সাধারণ নাম",
      genus: "গণ",
